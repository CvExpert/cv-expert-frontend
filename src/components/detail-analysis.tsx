  ...
  return (
    <Accordion variant="splitted">
      <AccordionItem key="1" aria-label="Guidelines" title="Guidelines">
        <ul>
          <li>
            Work on making good software products and have a good product to showcase your skills.
          </li>
          <li>Have a strong understanding of the tech stack you are using.</li>
          <li>
            The reason you're not getting a resume call could be due to a lack of a strong product
            and a clear way to present it.
          </li>
      ...
      <AccordionItem key="3" aria-label="Resume Analysis Flow" title="Resume Analysis Flow">
        <ol>
          ...
          <li>
            Analysis generates insights on word count, experience, education, and achievements
          </li>
        </ol>
      </AccordionItem>
      ...
      <AccordionItem key="4" aria-label="Database Design" title="Database Design">
        <pre>
          user: - userID: string - firstName: string - lastName: string - password: string files: -
          fileID: string - userID: string - fileLink: string analysis: - fileID: string -
          wordLength: string - experience: string - education: string - achievements: string
        </pre>
      </AccordionItem>
